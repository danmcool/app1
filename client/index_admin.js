angular.module('app1_admin', ['ngRoute', 'ngResource', 'ngMaterial'])
  ...
  .factory('UserProfiles', ['$resource', function($resource) {
  ...
  .factory('DataModelRelations', ['$resource', function($resource) {
    return $resource('/api/datamodelrelation/:id', null, {
      'update': {
        method: 'PUT'
      }
    });
  }])
  .controller('WorkflowsCtrl', ['$scope', 'Workflows', function($scope, Workflows) {
    $scope.workflows = Workflows.query({skip: 0, limit: 100});
    $scope.save = function() {
  ...
  .controller('ApplicationsCtrl', ['$scope', 'Applications', function($scope, Applications) {
    $scope.applications = Applications.query({skip: 0, limit: 100});
    $scope.save = function() {
  ...
  .controller('FormsCtrl', ['$scope', 'Forms', function($scope, Forms) {
    $scope.forms = Forms.query({skip: 0, limit: 100});
    $scope.save = function() {
  ...
  .controller('ValuesCtrl', ['$scope', 'Values', function($scope, Values) {
    $scope.values = Values.query({skip: 0, limit: 100});
    $scope.save = function() {
  ...
  .controller('UserProfilesCtrl', ['$scope', 'UserProfiles', function($scope, UserProfiles) {
    $scope.userprofiles = UserProfiles.query({skip: 0, limit: 100});
    $scope.save = function() {
  ...
  .controller('CompaniesCtrl', ['$scope', 'Companies', function($scope, Companies) {
    $scope.companies = Companies.query({skip: 0, limit: 100});
    $scope.save = function() {
  ...
  .controller('UsersCtrl', ['$scope', 'Users', function($scope, Users) {
    $scope.users = Users.query({skip: 0, limit: 100});
    $scope.save = function() {
  ...
  .controller('FilesCtrl', ['$scope', 'Files', function($scope, Files) {
    $scope.files = Files.query({skip: 0, limit: 100});
    $scope.save = function() {
  ...
  .controller('DataModelsCtrl', ['$scope', 'DataModels', function($scope, DataModels) {
    $scope.datamodels = DataModels.query({skip: 0, limit: 100});
    $scope.save = function() {
  ...
  .controller('DataModelRelationsCtrl', ['$scope', 'DataModelRelations', function($scope, DataModelRelations) {
    $scope.datamodelrelations = DataModelRelations.query({skip: 0, limit: 100});
    $scope.save = function() {
      if (!$scope.newDataModelRelation || $scope.newDataModelRelation.length < 1) return;
      var datamodelrelation = new DataModelRelations({
        name: $scope.newDataModelRelation
      });
      datamodelrelation.$save(function() {
        $scope.datamodelrelations.push(datamodelrelation);
        $scope.newDataModelRelation = '';
      });
    }
    $scope.remove = function(index) {
      var datamodelrelation = $scope.datamodelrelations[index];
      DataModelRelations.remove({
        id: datamodelrelation._id
      }, function() {
        $scope.datamodelrelations.splice(index, 1);
      });
    }
  }])
  .controller('WorkflowDetailsCtrl', ['$scope', '$routeParams', 'Workflows', '$location', function($scope,
  ...
  .controller('ApplicationDetailsCtrl', ['$scope', '$routeParams', 'Applications', '$location', function($scope,
  ...
  .controller('DataModelDetailsCtrl', ['$scope', '$routeParams', 'DataModels', '$location', function($scope,
  ...
  .controller('DataModelRelationDetailsCtrl', ['$scope', '$routeParams', 'DataModelRelations', '$location', function(
    $scope,
    $routeParams, DataModelRelations, $location) {
    $scope.datamodelrelation = DataModelRelations.get({
      id: $routeParams.id
    });
    $scope.update = function() {
      DataModelRelations.update({
        id: $scope.datamodelrelation._id
      }, $scope.datamodelrelation, function() {
        $location.url('/datamodelrelations');
      });
    }
  }])
  .controller('FormDetailsCtrl', ['$scope', '$routeParams', 'Forms', '$location', function($scope, $routeParams,
    Forms, $location) {
  ...
  .controller('ValueDetailsCtrl', ['$scope', '$routeParams', 'Values', '$location', function($scope, $routeParams,
    Values, $location) {
  ...
  .controller('UserProfileDetailsCtrl', ['$scope', '$routeParams', 'UserProfiles', '$location', function($scope,
  ...
  .controller('CompanyDetailsCtrl', ['$scope', '$routeParams', 'Companies', '$location', function($scope,
  ...
  .controller('UserDetailsCtrl', ['$scope', '$routeParams', 'Users', '$location', function($scope, $routeParams,
    Users, $location) {
  ...
  .controller('FileDetailsCtrl', ['$scope', '$routeParams', 'Files', '$location', function($scope, $routeParams,
    Files, $location) {
  ...
  .config(['$routeProvider', function($routeProvider) {
    $routeProvider
      ...
      .when('/datamodelrelations', {
        templateUrl: 'datamodelRelations.html',
        controller: 'DataModelRelationsCtrl'
      })
      .when('/datamodelrelations/:id', {
        templateUrl: 'datamodelRelationDetails.html',
        controller: 'DataModelRelationDetailsCtrl'
      })
      .when('/forms', {
