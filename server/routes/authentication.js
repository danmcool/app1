...
router.get('/validate', function(req, res) {
  ...
  User.findOneAndUpdate({
    ...
    validated: false
  }, { $set : { validated: true } }, function(err, object) {
    if (err) return next(err);
    ...
    var objectList = {};
    Application.find({_company_code:Constants.ProductionCompany}, function(err, appObjects) {
...
router.post('/login', function(req, res, next) {
  Company.findOne({_company_code: req.body._company_code}, 'name',
