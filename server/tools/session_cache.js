...
SessionCache.prepareUser = function (userObject) {
    ...
    if (userObject.reports && userObject.reports.length > 0) strUser = strUser.replace(/'@@reports'/g, (userObject.reports ? (userObject.reports.length > 0 ? JSON.stringify(userObject.reports).replace(/]|[[]/g, '') : '') : ''));
